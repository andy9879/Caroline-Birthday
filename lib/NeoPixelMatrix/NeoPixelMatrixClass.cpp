...
class NeoPixelMatrix{
  ...
  public:
    ...
    void addChar(char ch, uint8_t r, uint8_t g, uint8_t b){
      bool boolOutArr [8][4];
    ...
    void addSpecial(char ch, uint8_t r, uint8_t g, uint8_t b){
      bool boolOutArr [8][5];
      ...
      for(int i = 0; i < space * 8; i++){
        pixels.setPixelColor(i+((cusor+5)*8),backgroundColor[0],backgroundColor[1],backgroundColor[2]);
      }
